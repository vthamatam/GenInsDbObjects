/* Formatted on 23/May/17 8:36:49 PM (QP5 v5.300) */
    ...
    BEGIN
        ...
        THEN
            ...
            LOOP
                ...
                IF lv_policy_dtls (i).vehicle_dtls.EXISTS (1)
                THEN
                    ...
                    LOOP
                        ...
                        BEGIN
                            INSERT
                              INTO XXGEN_POLICY_VEHICLE_DTLS (
                                       VEHICLE_ID,
                                       POLICY_NO,
                                       VEHICLE_YEAR,
                                       VEHICLE_MAKE,
                ...
                IF lv_policy_dtls (i).risk_details.EXISTS (1)
                THEN
                    ...
                    LOOP
                        ...
                        calc_risk_prem (
                            ...
                            p_risk_code_i     => lv_policy_dtls (i).risk_details (
                                                    J).RISK_CODE,
                            p_risk_SA_i       => lv_policy_dtls (i).risk_details (
                                                    J).risk_si,
                        ...
                        -- start ReINsurance logic
                        BEGIN
                            SELECT MAX_RETENSION_LIMIT
                              INTO ln_retension_max
                        ...
                        EXCEPTION
                            WHEN NO_DATA_FOUND
                            THEN
                                ln_retension_max := 9999999999999999999999999;
                            WHEN OTHERS
                            THEN
                                ln_retension_max := 9999999999999999999999999;
                        END;
						dbms_output.put_line('ln_retension_max :'||ln_retension_max);
						dbms_output.put_line('lv_policy_dtls (i).risk_details (J).risk_si :'||lv_policy_dtls (i).risk_details (J).risk_si);
                        IF ln_retension_max <
                               lv_policy_dtls (i).risk_details (J).risk_si
                        THEN
                            XXGEN_CREATE_EDIT_RI_PKG.CREATE_RI (
					...
					dbms_output.put_line('RI call lv_status :'||lv_status||':'||lv_err_msg);
                            IF lv_err_msg = 'E'
                            THEN
                                xxgen_error_log (
                                    pi_policy_no        => ln_policy_no,
                                    pi_submitter_id     => ln_submited_id,
                                    pi_err_msg          =>    'Error while calling api xxgen_create_edit_RI_pkg.create_RI'
                                                           || SUBSTR (
                                                                  DBMS_UTILITY.format_error_backtrace,
                                                                  1,
                                                                  400)
                        ...
                        BEGIN
                            INSERT
                              INTO XXGEN_POLICY_RISk_DTLS (POLICY_RISK_ID,
                                                           POLICY_NO,
                                                           RISK_CODE,
                                                           Risk_description,
                                                           RISK_SA,
                ...
                IF lv_policy_dtls (i).driver_dtls.EXISTS (1)
                THEN
