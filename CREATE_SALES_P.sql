CREATE OR REPLACE PROCEDURE CREATE_SALES_PRC (P_PROD_ID_i             NUMBER,
                             P_CUST_ID_i             NUMBER,
                             P_TIME_ID_I             DATE,
...
ALTER SESSION SET SQL_TRACE = FALSE; 
 ...
 /
 TKPROF D:\oracle\product\10.2.0\admin\WIP\udump\wip_ora_6844.trc C:\VenuPerfomancetune\TKproof_rep24_1.txt explain=sh/oracle@wip table=sys.plan_table
   --=========================Profile
DECLARE
   l_result       BINARY_INTEGER;
   L_PROD_ID      NUMBER := 14;
